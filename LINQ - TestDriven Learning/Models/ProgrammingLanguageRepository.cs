        ...
        public static IEnumerable<ProgrammingLanguage> GetProgrammingLanguages()
        {
            yield return new ProgrammingLanguage
            {
                ...
                ObjectTypes = new List<ObjectType>
                    {new ObjectType {Id = 1, Name = "String"}, new ObjectType {Id = 2, Name = "Int"}},
                MarketShare = 30,
                DerivedFromC = true
            };
            ...
            yield return new ProgrammingLanguage
                {
                    ...
                    TypeId = 1,
                    ObjectTypes = new List<ObjectType>
                        {new ObjectType {Id = 1, Name = "Float"}, new ObjectType {Id = 2, Name = "String"}},
                    MarketShare = 24,
                    DerivedFromC = true
                }
                ;
            yield return new ProgrammingLanguage
                {
                    ...
                    {
                        new ObjectType {Id = 1, Name = "String"}, new ObjectType {Id = 2, Name = "Int"},
                        new ObjectType {Id = 2, Name = "Float"}
                    },
                    MarketShare = 7,
                    DerivedFromC = true
                }
